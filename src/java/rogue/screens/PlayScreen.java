...
public class PlayScreen implements Screen {
     ...
     *
     * @param factory - the StuffFactory object through which the creatures will be
     *                created
     */
     ...
     * display
     *
     * @param terminal - the terminal on which to display the tiles
     * @param left     - the left-most x coordinate of the world that is visible on the
     *                 screen
     * @param top      - the top-most y coordinate of the world that is visible on the
     *                 screen
     */
    ...
    public void displayOutput(AsciiPanel terminal) {
        ...
        String stats = String.format(" %3d/%3d hp  %d/%d mana  %8s  vision %d", player.hp(), player.maxHp(),
                player.mana(), player.maxMana(), hunger(), Math.max(0, player.stealthRadius()));
        terminal.write(stats, 1, 32);
     ...
     *
     * @param terminal - the terminal on which to display the messages
     * @param messages - the messages which to display
     */
    ...
    public Screen respondToUserInput(KeyEvent key) {
        ...
        if (subscreen == null && shouldUpdate) world.update();
