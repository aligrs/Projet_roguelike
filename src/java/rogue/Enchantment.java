...
class Enchantment {
    ...
    private void initAll() {
        goodWeaponPrefixes = new ArrayList<>();
        badWeaponPrefixes = new ArrayList<>();
        goodWeaponSuffixes = new ArrayList<>();
        badWeaponSuffixes = new ArrayList<>();
        goodArmorPrefixes = new ArrayList<>();
        badArmorPrefixes = new ArrayList<>();
        goodArmorSuffixes = new ArrayList<>();
        badArmorSuffixes = new ArrayList<>();
        goodRingSuffixes = new ArrayList<>();
        badRingSuffixes = new ArrayList<>();
        goodCharmSuffixes = new ArrayList<>();
        badCharmSuffixes = new ArrayList<>();

        goodWeaponPrefixEffects = new HashMap<>();
        badWeaponPrefixEffects = new HashMap<>();
        goodWeaponSuffixEffects = new HashMap<>();
        badWeaponSuffixEffects = new HashMap<>();
        goodArmorPrefixEffects = new HashMap<>();
        badArmorPrefixEffects = new HashMap<>();
        goodArmorSuffixEffects = new HashMap<>();
        badArmorSuffixEffects = new HashMap<>();
        goodRingSuffixEffects = new HashMap<>();
        badRingSuffixEffects = new HashMap<>();
        goodCharmSuffixEffects = new HashMap<>();
        badCharmSuffixEffects = new HashMap<>();
    }
    ...
    static List<String> getGoodWeaponPrefixes() {
        return goodWeaponPrefixes;
    }

    static List<String> getBadWeaponPrefixes() {
        return badWeaponPrefixes;
    }

    static List<String> getGoodWeaponSuffixes() {
        return goodWeaponSuffixes;
    }

    static List<String> getBadWeaponSuffixes() {
        return badWeaponSuffixes;
    }

    static List<String> getGoodArmorPrefixes() {
        return goodArmorPrefixes;
    }

    static List<String> getBadArmorPrefixes() {
        return badArmorPrefixes;
    }

    static List<String> getGoodArmorSuffixes() {
        return goodArmorSuffixes;
    }

    static List<String> getBadArmorSuffixes() {
        return badArmorSuffixes;
    }

    static List<String> getGoodRingSuffixes() {
        return goodRingSuffixes;
    }

    static List<String> getBadRingSuffixes() {
        return badRingSuffixes;
    }

    static List<String> getGoodCharmSuffixes() {
        return goodCharmSuffixes;
    }

    static List<String> getBadCharmSuffixes() {
