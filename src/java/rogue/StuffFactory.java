...
public class StuffFactory {
     ...
     *
     * @param world - the world in which the StuffFactory will spawn creatures
     */
    ...
    private void setUpScrollAppearances() {
        scrollAppearances = new ArrayList<>();
     ...
     *
     * @param messages - the list of messages that will be sent to the player throughout
     *                 the game
     * @param fov      - the FieldOfView object linked to the player, which helps figure
     ...
     *
     * @param depth  - the depth at which to create the zombie
     * @param player - the player which the zombies will aggro
     */
     ...
     *
     * @param depth  - the depth at which to create the goblin
     * @param player - the player which the goblin will aggro
     */
    ...
    public void newTroll(int depth, Creature player) {
     ...
     *
     * @param depth - the depth at which to spawn said item
     */
     ...
     * @param depth - the depth at which to spawn said item
     */
    public void newApple(int depth) {
        Item apple = new Item(';', AsciiPanel.red, "apple", null);
        apple.modifyFoodValue(100);
        apple.isFood(true);
     ...
     * @param depth - the depth at which to spawn said item
     */
    public void newBread(int depth) {
        Item bread = new Item(';', AsciiPanel.yellow, "bread", null);
        bread.modifyFoodValue(400);
        bread.isFood(true);
     ...
     *
     * @param depth - the depth at which to spawn said weapon
    ...
    private Item newMace(int depth) {
    ...
    private Item newSpear(int depth) {
    ...
    private Item newHalberd(int depth) {
    ...
    private Item newClub(int depth) {
     ...
     *
     * @param depth - the depth at which to spawn said armor
     * @return returns the newly created "light armor" item
     */
    private Item newTunic(int depth) {
     ...
     */
    private Item newChainmail(int depth) {
     ...
     */
    private Item newPlatemail(int depth) {
    ...
    private Item newRobes(int depth) {
    ...
    private Item newRing() {
        Item item = new Item('*', AsciiPanel.brightBlue, "ring", null);
        item.isRing(true);
        Enchantment e = new Enchantment(item);
        e.generateEnchantedItem(item);
        return item;
    ...
    private void newRing(int depth) {
        Item item = new Item('*', AsciiPanel.brightBlue, "ring", null);
        item.isRing(true);
        Enchantment e = new Enchantment(item);
        e.generateEnchantedItem(item);
    ...
    private Item newCharm() {
        Item item = new Item('ç', AsciiPanel.brightGreen, "charm", null);
        item.isCharm(true);
        Enchantment e = new Enchantment(item);
        e.generateEnchantedItem(item);
        return item;
    ...
    private void newCharm(int depth) {
        Item item = new Item('ç', AsciiPanel.brightGreen, "charm", null);
        item.isCharm(true);
        Enchantment e = new Enchantment(item);
        e.generateEnchantedItem(item);
     ...
     *
     * @param depth - the depth at which to spawn said potion
     */
    ...
    private void newPotionOfInvisibility(int depth) {
        String appearance = potionAppearances.get(1);
        Item item = new Item('!', potionColors.get(appearance), "invisibility potion", appearance);
        item.setQuaffEffect(new Effect(5) {
     ...
     * @param depth - the depth at which to spawn said potion
     */
    private void newPotionOfLight(int depth) {
     ...
     * @param depth - the depth at which to spawn said potion
     */
    private void newPotionOfBlindness(int depth) {
    ...
    private void newPotionOfStrength(int depth) {
    ...
    private void newPotionOfDetection(int depth) {
    ...
    private void newScrollOfEnchantment(int depth) {
    ...
    private void newScrollOfIdentify(int depth) {
    ...
    private void newScrollOfRemoveCurse(int depth) {
     ...
     *
     * @param depth - the depth at which to spawn said spellbook
     */
    ...
    private void newRedMagesSpellbook(int depth) {
    ...
    public void newRandomRing(int depth) {
        switch ((int) (Math.random() * 3)) {
            case 0:
                newRing(depth);
                return;
    ...
    public void newRandomCharm(int depth) {
        switch ((int) (Math.random() * 3)) {
            case 0:
                newCharm(depth);
                return;
    ...
    public void newRandomScroll(int depth) {
        switch ((int) (Math.random() * 2)) {
            case 0:
                newScrollOfEnchantment(depth);
                return;
            case 1:
                newScrollOfIdentify(depth);
                return;
            default:
                newScrollOfRemoveCurse(depth);
        }
    }
     ...
     * @param depth - the depth at which to spawn said potion
     */
    public void newRandomPotion(int depth) {
        switch ((int) (Math.random() * 8)) {
            case 0:
                newPotionOfHealth(depth);
                return;
            case 1:
                newPotionOfInvisibility(depth);
                return;
            case 2:
            ...
            case 3:
                ...
                return;
            case 4:
                newPotionOfLight(depth);
                return;
            case 5:
                newPotionOfBlindness(depth);
                return;
            case 6:
                newPotionOfWarrior(depth);
                return;
            case 7:
                newPotionOfStrength(depth);
                return;
            default:
                newPotionOfDetection(depth);
        }
    }
     ...
     * @param depth - the depth at which to spawn said spellbook
     */
    public void newRandomSpellbook(int depth) {
        switch ((int) (Math.random() * 3)) {
            case 0:
