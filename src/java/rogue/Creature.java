...
public class Creature {
     ...
     *
     * @param world   - the world in which the creature is located
     * @param name    - the name of the creature
     * @param glyph   - the char that represents the creature
     * @param color   - the color of the glyph
     * @param maxHp   - the maximum hp of the creature
     * @param maxMana - the maximum mana of the creature
     * @param attack  - the attackValue of the creature
     * @param defense - the defenseValue of the creature
     */
    ...
    public Creature(World world, String name, char glyph, Color color, String className) {
        ...
        rogue.Class startingClass = getClassStats(className);
    ...
    private rogue.Class getClassStats(String startingClass) {
        if (this.isPlayer()) {
        ...
        return new rogue.Class(100, 50, 10, 100, 5, 5, 3, 3, startingItems);
    }

    private rogue.Class getPlayerClass(String startingClass) {
        ...
        if (startingClass.equalsIgnoreCase("knight")) {
            ...
            return new rogue.Class(250, 50, 0, 100, 7, 9, 3, 2, startingItems);
            ...
            return new rogue.Class(200, 50, 25, 100, 5, 6, 5, 2, startingItems);
            ...
            return new rogue.Class(100, 50, 50, 200, 4, 4, 1, 1, startingItems);
            ...
            return new rogue.Class(150, 50, 15, 100, 9, 7, 2, 4, startingItems);
            ...
            return new rogue.Class(125, 50, 10, 100, 8, 8, 2, 5, startingItems);
        } else {
            ...
            return new rogue.Class(200, 50, 10, 100, 6, 6, 5, 5, startingItems);
        }
    }
     ...
     * @param params  - the parameters to input into the message
     */
     ...
     * location
     *
     * @param wx - the x coordinate of the tile to search
     * @param wy - the y coordinate of the tile to search
     * @param wz - the z coordinate of the tile to search
     ...
     * user input
     *
     * @param mx - the direction to move along the x axis
     * @param my - the direction to move along the y axis
     * @param mz - the direction to move along the z level (up or down a floor)
     */
     ...
     * @param wz - the z level of the tile to check
     ...
     * world generation)
     *
     * @param other - the creature being summoned
     */
     ...
     * @param x2    - the x direction the spell is being cast
     * @param y2    - the y direction the spell is being cast
     */
     ...
     *
     * @param other - the creature being slain for xp
     */
     ...
     *
     * @param message - the message you want to display to others
     * @param params  - the parameters to input into the message
     */
     ...
     * Similar to the
     *
     * @param item    - the item being used upon action
     * @param message - the message you want to display to others
     * @param params  - the parameters to input into the message
     */
     ...
     *
     * @param amount       - the amount to modify hp by
     * @param causeOfDeath - String representing a cause of death related to what caused
     *                     fatal damage
     */
     ...
     *
     * @param amount - amount to modify food level by
     */
    ...
    /**
     * @param item - item to be eaten/quaffed
     */
     ...
     * @param wx   - the x direction for the item to be thrown in
     * @param wy   - the y direction for the item to be thrown in
     * @param wz   - the z level on which the item is being thrown
     */
     ...
     *
     * @param amount - the amount to modify how fast a creature regens hp
     */
     ...
     *
     * @param amount - the amount to modify how fast a creature regens mana
     */
     ...
     *
     * @param other  - the creature being attacked
     * @param attack - the damage being dealt
     * @param action - the notification action to display
     * @param params - the parameters to pass into the action message
     */
     ...
     *
     * @param item - item being thrown
     * @param wx   - x direction of where item is being placed
     * @param wy   - y direction of where item is being placed
     * @param wz   - z level of where the item is being placed
     */
     ...
     *
     * @param amount - used to alter the state of a creature's "sixth sense"
     */
     ...
     * tile/creature
     *
     * @param wx - x coordinate of tile to check
     * @param wy - y coordinate of tile to check
     * @param wz - z level to check
     ...
     * @param wx - x coordinate of tile to check
     * @param wy - y coordinate of tile to check
     * @param wz - z level of tile to check
     ...
     *
     * @param amount - amount by which to modify a creature's mana
     */
     ...
     *
     * @param amount - amount by which to modify a creature's max hp
     */
     ...
     *
     * @param amount - amount by which to modify a creature's max mana
     */
     ...
     *
     * @param amount - amount by which to modify a creature's attack value
     */
     ...
     *
     * @param amount - amount by which to modify a creature's defense value
     */
     ...
     *
     * @param amount - the amount by which to modify a creature's vision radius
     */
     ...
     *
     * @param item - item to return name of
     ...
     *
     * @param item - item to learn the real name of
     */
     ...
     *
     * @param amount - the amount by which to modify a creature's xp
     */
