...
/**
 * Classe qui definit un niveau <code>depth</code>.
 */
public class World {
     ...
     *
     * @param tiles - the set of tiles that make up the world
     */
    World(Tile[][][] tiles) {
        this.tiles = tiles;
     ...
     *
     * @param x - x coordinate of the tile to search
     * @param y - y coordinate of the tile to search
     * @param z - the z level on which to search
     ...
     * @param depth    - the z level on which to add the creature
     */
    void addAtEmptyLocation(Creature creature, int depth) {
        int x;
        int y;
     ...
     * @param depth - the z level on which to add the creature
     */
    void addAtEmptyLocation(Item item, int depth) {
        int x;
        int y;
     ...
     * @param y    - the y coordinate to start with
     * @param z    - the z level to start with
     * @return returns true if it can be placed, otherwise false
     */
    boolean addAtEmptySpace(Item item, int x, int y, int z) {
     ...
     *
     * @param x - x coordinate of tile to remove item from
     * @param y - y coordinate of tile to remove item from
     * @param z - z level of tile to remove item from
     */
     ...
     * @param z - the z level to check the tile on
     ...
     *
     * @param pet - creature to be added
     */
